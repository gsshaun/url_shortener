...
<c:url value="/resources/bottom.png" var="bottom-image" />
	...
	<div id="form_container">
		...
		<form id="form_32770" class="appnitro"  method="get" action="processData">
			...
			<h2>URL Shortener</h2>
			<p>Here, is the shorted URL</p>
		</div>						
			<ul >
			
					<li id="li_1" >
		<label class="description" for="element_1">Shortened URL: </label>
		<div>
			<td><a ref=http://localhost:6187/URL-Shortner/${id}>http://localhost:6187/URL-Shortner/${id}</a> </td>
		</div> 
